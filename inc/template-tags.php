...
function soblossom_paging_nav() {
	...
	<nav class="navigation paging-navigation" role="navigation">
		...
		<div class="nav-links">
			...
			<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Older posts', 'soblossom' ) ); ?></div>
			<?php endif; ?>

			<?php if ( get_previous_posts_link() ) : ?>
			<div class="nav-next"><?php previous_posts_link( __( 'Newer posts <span class="meta-nav">&rarr;</span>', 'soblossom' ) ); ?></div>
			<?php endif; ?>
...
function soblossom_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		...
		<div class="nav-links">
			<?php
				previous_post_link( '<div class="nav-previous">%link</div>', _x( '<span class="meta-nav">&larr;</span>&nbsp;%title', 'Previous post link', 'soblossom' ) );
				next_post_link(     '<div class="nav-next">%link</div>',     _x( '%title&nbsp;<span class="meta-nav">&rarr;</span>', 'Next post link',     'soblossom' ) );
			?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
	<?php
...
function soblossom_categorized_blog() {
	if ( false === ( $all_the_cool_cats = get_transient( 'soblossom_categories' ) ) ) {
		...
		set_transient( 'soblossom_categories', $all_the_cool_cats );
	}
...
function soblossom_category_transient_flusher() {
	// Like, beat it. Dig?
	delete_transient( 'soblossom_categories' );
}
