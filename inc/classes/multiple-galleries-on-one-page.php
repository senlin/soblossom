...
function soblossom_clearing_blockgrid_gallery( $attr ) {
	...
	$gallery_div = '<div id="gallery-' . $id . '" class="soblossom-gallery"><ul class="clearing-thumbs clearing-feature" data-clearing>';
	...
	foreach ( $attachments as $id => $attachment ) {
		...
		// see line 172 and 190-191 too; @source: stackoverflow.com/a/20940103/1381553
		$output .= $isFirst ? '<li class="clearing-featured-img">' : '<li>';
		$isFirst = false;
